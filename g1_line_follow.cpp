...
double angle=0.0,angle_tem=0.0,direction_time=0.0;
/*****PID control*****/
struct _pid                    //PID数据结构
{
  float SetSpeed;
...

{
  ...
  direction_time+=error_direction;     //实际的转化航向
  odom_direction=0;
 
  if(direction_time>=6.28)
       direction_time-=6.28;
  ROS_INFO("direction_time=%f",direction_time);
...

{
 ...
 double b[8]={0,0,0,0,0,0,0,0}, pid_angular_z=0;
 ...
 switch (k)
     ...
     if( k>3  )            //里程计算法
              { 
               ...
               if(flag_4==1)
                   ...
                   {
                     flag_4=0;
                     angle_tem=-6.28-direction_time;           //    0 
                   ...
                   {
                     flag_3=0;
                     angle_tem=-1.067-direction_time;     //   5.233=5*3.14/3 
                  ...
                  {
                     flag_2=0;
                     angle_tem=6.28-direction_time;     //    6.28=2*3.14
                     ROS_INFO("angle_tem2:%f",angle_tem);
                     flag_3=1;    
                   ...
                   {
                     flag_1=0;
                     angle_tem=1.067-direction_time;     //   1.067=3.14\3
                     ROS_INFO("angle_tem1:%f",angle_tem);
                     flag_2=1;    
  ...
  k=0;
    ...
    if (switch_state>0)
  {
    line_follower_vel.linear.x=-0.05;  
